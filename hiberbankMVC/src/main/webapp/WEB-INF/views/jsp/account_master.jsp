<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <head>
        ...
        <script src="../resources/core/js/hb_account.js"></script>
                        ...
                        <div class="row">
                            ...
                            <div class="col right">
                                <div class="input-field col ">
                                    <input id="customer-filter-input" type="text" class="validate">
                                    <label>Customer</label>
                                </div>
                                <div class="input-field col ">
                                    <input id="nbu-filter-input" type="text" class="validate">
                                    <label>NBU</label>
                                </div>
                                <div id="filter" class="btn-floating grey" ng-click="showTabs = !showTabs">
                                    <i class="mdi mdi-filter"></i>
                                </div>
                                <div id="remove-filter" class="btn-floating grey" ng-click="showTabs = !showTabs">
                        ...
                        <div class="" id="tabs" ng-init="showTabs=true">
                            ...
                            <div id="data-table-customer" class="">
                                <table class="responsive-table display" cellspacing="0">
                                    ...
                                    <tbody id="data-table-account-body">
